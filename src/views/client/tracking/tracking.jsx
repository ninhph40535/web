            ...
            {searchValueMa && searchValueSDT ? (
                hoaDon ? ( // Kiểm tra nếu hoaDon có dữ liệu
                    <Card
                        ...
                        actions={[<Button onClick={() => handleViewHoaDonDetail(hoaDon.code)} style={{ border: '1px solid #6A0DAD', color: '#6A0DAD' }} type="light" icon={<CheckCircleOutlined />}>Thông Tin Chi Tiết</Button>]}>
                        <div>
