        ...
        <>
            ...
            <Formik
                ...
                validationSchema={Yup.object().shape({
                    ...
                    phoneNumber: Yup.string().max(20).required('Số điện thoại là bắt buộc'),
                    password: Yup.string().max(255).required('Mật khẩu là bắt buộc'),
                    customerName: Yup.string().max(255).required('Tên khách hàng là bắt buộc') // Thêm validation cho customerName
                })}
