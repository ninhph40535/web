              ...
              <Col xl={10} md={24}>
                <ul className="list-unstyled">
                  ...
                  <li className="mb-2">
                   ...
                   {/* Thêm điều kiện để hiển thị PaymentModal */}
{
  (billPayment.totalMoney < totalMoney - discountValue || invoiceType !== "TRUC_TUYEN") && (
    <PaymentModal
 ...
 <li className="mb-2">
                    Tiền khách đưa:
                    <span className="float-end fw-semibold text-danger">
                      <FormatCurrency value={billPayment.totalMoney} />
                    </span>
                  </li>
